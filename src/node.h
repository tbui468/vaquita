...
void vdbnode_intern_write_type(uint8_t* buf); //TODO replace
void vdbnode_intern_write_parent(uint8_t* buf, uint32_t parent_idx); //TODO: replace with general version
...
void vdbnode_leaf_write_type(uint8_t* buf); //TODO: replace
void vdbnode_leaf_write_parent(uint8_t* buf, uint32_t parent_idx); //TODO: replace with general version
...
void vdbnode_data_write_type(uint8_t* buf); //TODO: replace
void vdbnode_data_write_parent(uint8_t* buf, uint32_t parent_idx); //TODO: replace with general version
